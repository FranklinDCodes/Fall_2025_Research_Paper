...
% \subsection{Get list of stocks by market cap}
% \subsection{Generate stock list}
% \subsection{Download data}
% \subsection{Store data in csv files}
...
\subsubsection{Setup first inputs}
    Create empty list for inputs and labels. Prefetch first n batches by indexing them out of dataset and adding them to inputs and labels. Remove these indices from batch indices.
