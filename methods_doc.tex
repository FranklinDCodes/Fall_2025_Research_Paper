...
\section{Training}
\subsubsection{Load and unpack config}
    Config loaded as a json object .
...
\subsubsection{Init model}
    The pytorch model is initialized. The custom model class is given a name, starting LR, and input feature count from dataset.
