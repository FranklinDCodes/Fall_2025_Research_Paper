...
\subsection{Separate validation set}
...
\subsection{Get model predictions}
...
\subsection{Calculate positions opened}
...
\subsection{Calculate positions sell prices}
    ...
    \label{fig2}
    \end{figure}
\subsection{Calculate positions outcomes}
